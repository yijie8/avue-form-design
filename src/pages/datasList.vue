<template>
    <div style="margin-top: 10px">
        <avue-crud :data="data" :option="option" v-model="obj" :before-close="beforeOpen" @on-load="onLoad"
                   @row-save="rowSave" @row-update="rowUpdate" @row-del="rowDelete" @refresh-change="rowChange"
                   :page.sync="page" :table-loading="loading" ref="crud" @selection-change="selectionChange"
        ...
        <div style="margin-top: -40px">
            ...
            <el-button type="danger" style="margin-left:10px;z-index:99999999" @click.stop="toggleSelection()">删除所选
            </el-button>
        </div>
    </div>
</template>
...
// return;
        ...
        list.forEach((val, key) => {
          let id = this.dataAll[val.$index].id;
          updateAll.push({
            id: id,
        ...
        let res = await this.api("index/datasOrder", {
          soft: updateAll,
        });
