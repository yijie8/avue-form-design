<template>
  <div>
    ...
    <el-button type="danger"
      ...
      size="small"
      plain
      @click.stop="$router.push({name:'form',query:{action:'add'}})">新增</el-button>
  </template>
      ...
      <template slot-scope="scope" slot="menu">
        ...
        <el-button icon="el-icon-edit" size="small" type="text" @click="$router.push({name:'form',params:scope.row})">编辑</el-button>
